...
const HeroSlider: React.FC<HeroSliderProps> = ({ 
  ...
  if (activeItems.length === 0) {
    return (
      <div className="relative h-[500px] md:h-[600px] w-full bg-gradient-to-br from-pink-100 via-purple-50 to-indigo-100 flex items-center justify-center" style={{ aspectRatio: '16/9' }}>
  ...
  return (
    <div className="relative h-[500px] md:h-[600px] w-full overflow-hidden" style={{ aspectRatio: '16/9' }}>
